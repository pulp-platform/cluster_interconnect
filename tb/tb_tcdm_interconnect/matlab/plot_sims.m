...
% scatterplot_tests(stats, '128x', {'clos_2mn', 'clos_m1n', 'clos_m2n', 'bfly2_n1', 'bfly2_n2','bfly2_n4', 'bfly4_n1', 'bfly4_n2','bfly4_n4','bfly4_n8', 'lic'},'random linear bursts (p_{req}=1.00, len_{max}=100.00)');
